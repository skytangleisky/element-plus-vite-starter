...
const zoomFunc = () => {
  setting.无人机.编辑.zoom = map.getZoom();
};
const moveFunc = () => {
  let center = map.getCenter();
  setting.无人机.编辑.center = [center.lng, center.lat];
};
const task = () => {
...
onMounted(() => {
  map = new mapboxgl.Map({
    ...
    // pitch: 60,
    zoom: setting.无人机.编辑.zoom,
    center: setting.无人机.编辑.center,
    pitch: 0,
  });
  map.addControl(
