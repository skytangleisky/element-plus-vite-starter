<template>
  <div style="width: 100%; height: 100%; overflow: hidden; position: absolute">
    <edit-map
      ...
      v-model:loadmap="setting.无人机.监控.loadmap"
      v-model:district="setting.无人机.监控.district"
      v-model:tile="setting.无人机.监控.tile"
      v-model:center="setting.无人机.监控.center"
    ...
    <div :class="`right-drawer ${setting.无人机.监控.disappear ? 'disappear' : ''}`">
      ...
      <div style="display: flex; flex-direction: column">
        <el-checkbox
          v-model="setting.无人机.监控.loadmap"
          label="显示瓦片地图"
        ></el-checkbox>
        <el-checkbox
          v-model="setting.无人机.监控.district"
          label="显示行政区划"
        ></el-checkbox>
