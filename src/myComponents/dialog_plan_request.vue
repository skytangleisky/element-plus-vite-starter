<template>
  <div v-dialogDrag class="dragDialog absolute w-550px" style="left:0px;top:300px;">
    ...
    <el-row>
      <el-col :span="12"><div class="flex justify-between items-center pl-10px">最大射程(千米)<el-input-number v-model="num1" size="default"/></div></el-col>
      <el-col :span="12"><div class="flex justify-between items-center pl-10px">最大射高(米)<el-input-number v-model="num2" size="default"/></div></el-col>
    </el-row>
    <el-row>
      <el-col :span="12"><div class="flex justify-between items-center pl-10px">射击装备<input @mousedown.stop class="operation_filter" style="width:150px;" value="火箭"/></div></el-col>
      <el-col :span="12"><div class="flex justify-between items-center pl-10px">作业目的<input @mousedown.stop class="operation_filter" style="width:150px;" value="增雨"/></div></el-col>
    </el-row>
    <el-row>
      <el-col :span="12"><div class="flex justify-between items-center pl-10px">射向开始角(度)<el-input-number v-model="num3" size="default"/></div></el-col>
      <el-col :span="12"><div class="flex justify-between items-center pl-10px">射向终止角(度)<el-input-number v-model="num4" size="default"/></div></el-col>
    </el-row>
    <el-row>
