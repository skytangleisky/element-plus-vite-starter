<template>
  ...
  >
    <edit-map
      ...
      v-model:loadmap="setting.组网.回放.loadmap"
      v-model:district="setting.组网.回放.district"
      v-model:tile="setting.组网.回放.tile"
      v-model:center="setting.组网.回放.center"
      v-model:zoom="setting.组网.回放.zoom"
    ></edit-map>
    <el-date-picker
