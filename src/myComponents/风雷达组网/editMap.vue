...
onMounted(() => {
  ...
  map.on("load", async () => {
    ...
    //     // div.id = "风雷达组网" + item.id;
    //     // div.className = "deviceStation_风雷达组网";
...
onBeforeUnmount(() => {
  ...
  eventbus.off("风雷达组网-将站点移动到屏幕中心", flyTo);
