  ...
  <div style="height: 100%;display: flex;flex-direction: column;">
    ...
    <div style="height: 100%; overflow: auto;width:100%;box-sizing: border-box;position: relative;display: flex;">
      <div style="padding:10px">
        <div
          style="border-radius: 10px; overflow: auto;width: 250px;background-color: white;height: 100%;border:1px solid gray;"
          v-loading="loading"
        >
          <el-tree
      ...
      <div style="width: 100%;padding:10px;">
        ...
        >
          <chart-fkx style="width: 100%;height: 100%;padding:10px;box-sizing: border-box;"></chart-fkx>
        </div>
      </div>
    </div>
  </div>
