...
export default class IsolineLayer extends BaseLayer{
  ...
  loadMap(obj,change,rect,isolineData,callback){
      ...
      for(let i=this._X0;i<this._X1;i++){
        ...
        if(this._X0<=item.i&&item.i<this._X1&&this._Y0<=item.j&&item.j<this._Y1&&item._LL==this._LL){
          ...
          if(data){
            ...
            this.load2({_LL:this._LL,i,j,_X0:this._X0,_X1:this._X1,_Y0:this._Y0,_Y1:this._Y1,isDrawed:true},obj,isolineData)
          }
        }
      }
    }
