export default {
  ...
  redirect: { path: '/device/synthesis' },
  ...
  children:[
    {
      path:'synthesis',
      name:'8f316b6a-96ed-e4ad-6f96-2899833db3b8',
    ...
    {
      path:'device',
      name:'8f316b6b-96ed-e4ad-6f96-3899833db3b8',
      hide:false,
      ...
      children:[
        {
          path: 'A6418',
          name: 'da20feec-5ad7-51e1-2789-5e0933011f11',
        ...
        {
          path: 'A6419',
          name: 'da20feed-5ad7-51e1-2788-5e0933011a11',
        ...
        {
          path: 'A6420',
          name: 'da20feee-5ad7-51e1-2787-5e0933011a11',
        ...
        {
          path: 'A6421',
          name: 'da20feef-5ad7-5111-2787-5e0933011a11',
        ...
        {
          path: 'A6422',
          name: 'da20feeg-5ad7-5121-2787-5e0933011a11',
        ...
        {
          path: 'A6423',
          name: 'da20feeh-5ad7-5131-2787-5e0933011a11',
    ...
    // {
    //   path: 'system',
    //   name:'aa4619ci-ca3d-ffb1-9781-afcf73cfa623',
    //   svg:'7809a650d6c811ee9aafb025aa2c9ada',
    //   redirect:'/device/system/device',
    //   meta:{
    //     label:'系统管理',
    //   },
    //   children:[
    ...
    //     {
    //       path: 'device',
    //       name: 'da20fee2-5ad7-51e1-2768-5e0933011a11',
